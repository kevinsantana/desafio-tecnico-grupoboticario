...
from cashback_api import __version__
from cashback_api.rotas import v1
from cashback_api.arquivos import html_desc
from cashback_api.rotas.v1 import doc_sphinx
...
def load_exceptions(app: FastAPI):
    @app.exception_handler(CashbackApiException)
    async def cashback_api_exception_handler(
        request: Request, exception: CashbackApiException
    ):  # pragma: no cover
        return JSONResponse(
